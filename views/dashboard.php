...
<body>
    ...
    <p><a href="/rechlytics/views/perfil.php">Editar Perfil</a></p>
    ...
    <?php if ($result->num_rows > 0): ?>
        <ul>
            <?php while ($row = $result->fetch_assoc()): ?>
                <li>
                    <a href="/rechlytics/views/ver_dashboard.php?id=<?php echo htmlspecialchars($row['id']); ?>">
    ...
    <p><a href="/rechlytics/views/chat.php">Falar com Suporte</a></p>
